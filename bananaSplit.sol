...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARDTOKEN = IERC20(0x9222D24274E912F4d5E889b460924C4fEFe97954); 
    ...
    uint256 public minDistribution = 1 * (1 ** 18);
...
contract BananaSplit is IERC20, Auth {
    using SafeMath for uint256;

    address REWARDTOKEN = 0x9222D24274E912F4d5E889b460924C4fEFe97954;
    address WETH = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BananaSplit";
    ...
    function swapBack() internal swapping {
        ...
        payable(marketingFeeReceiver).call{value: amountETHMarketing, gas: 50000}("");
        payable(charityFeeReceiver).call{value: amountETHCharity, gas: 50000}("");
